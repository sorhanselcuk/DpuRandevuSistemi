<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profil.aspx.cs" Inherits="DRS.WebUI.akademisyen.profil" %>
...
<head runat="server">
    <meta charset="UTF-8" />
<title>Akademisyen</title> <!--veritabanından giriş yapan öğrencinin adı soyadı çekilecek -->
<style>
        p{color:black;}
        body {
    ...
    <form id="form1" runat="server">
        ...
        <div class="container" style="margin:80px auto;">
            <div class="row">
                ...
                <asp:Button ID="btnMusaitlikler" runat="server" Text="Müsaitlik Ekle" CssClass="ayarlarButton2" OnClick="btnMusaitlikler_Click" />
            </div>
        </div>
</div>
    </form>
