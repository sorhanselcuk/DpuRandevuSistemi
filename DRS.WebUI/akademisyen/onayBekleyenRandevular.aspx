<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="onayBekleyenRandevular.aspx.cs" Inherits="DRS.WebUI.akademisyen.onayBekleyenRandevular" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="row">
                    ...
                    <asp:Table ID="RandevuTablosu" runat="server" CssClass="table table-striped table-hover mt-4">
                        <asp:TableHeaderRow TableSection="TableHeader">
                            ...
                            <asp:TableHeaderCell Scope="Column">Öğrenci</asp:TableHeaderCell>
        ...
        <asp:Button ID="btnIslem" runat="server" Text="" BorderWidth="0" Width="0" Height="0" OnClick="btnIslem_Click" />
