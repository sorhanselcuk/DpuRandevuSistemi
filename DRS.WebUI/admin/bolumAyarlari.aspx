<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bolumAyarlari.aspx.cs" Inherits="DRS.WebUI.admin.bolumAyarlari" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-wrapper">
            <div class="container" style="margin: 80px auto;">
                <div class="row">
                    <div style="display:none; margin-bottom:10px;" id="geriDon">
                        <a href="fakulteAyarlari.aspx" class="btn btn-light"><i class="fas fa-backward"></i>Geri Dön</a>
                    </div>
                    <asp:Button ID="btnIslem" runat="server" Text="" Width="0" Height="0" BorderWidth="0" OnClick="btnIslem_Click" />
                    
                      <div class ="bolumAyarlariTablo">  <asp:Table ID="BolumTablosu" runat="server" CssClass="table table-striped table-hover mt-4">
                            <asp:TableHeaderRow TableSection="TableHeader">
                                <asp:TableHeaderCell Scope="Column">#</asp:TableHeaderCell>
                                <asp:TableHeaderCell Scope="Column">Bolüm Ad</asp:TableHeaderCell>
                                <asp:TableHeaderCell Scope="Column">İşlem</asp:TableHeaderCell>
                            </asp:TableHeaderRow>
                        </asp:Table>
                      </div>

                    <div id="bolumEkle" style="display:none">
                    <p class ="pUnvan">Fakülte:</p>
                    <ajaxToolkit:ComboBox ID="cbxFakulteler" CssClass="inputUnvan" runat="server"></ajaxToolkit:ComboBox>
                  <p class = "pAdi">Bölüm Adı:</p><
                  <asp:TextBox ID="tbxBolumAd" CssClass="inputAdi" runat="server"></asp:TextBox>
                    <asp:Button ID="btnBolumEkle" CssClass="bolumAyarlariButton" runat="server" Text="Ekle" OnClick="btnBolumEkle_Click" />
                        </div>
                </div>
            </div>
        </div>
