<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ogrenciGiris.aspx.cs" Inherits="DRS.WebUI.ogrenciGiris" %>
...
<body>
    <form id="form1" runat="server"  onMouseOver  =" dogrulama()" >
        <div class="baslik">
            ...
            <p>
                <strong>
                    <h1>KÜTAHYA DUMLUPINAR ÜNİVERSİTESİ</h1>
                </strong>
            </p>
            <p>
                <h2 class="p3">ÖĞRENCİ GİRİŞİ</h2>
            </p>
        </div>
        <p class="p1">E-posta:</p>

        <asp:TextBox ID="tbxEPosta" runat="server" CssClass="input" TextMode="Email"></asp:TextBox>
        <br />
