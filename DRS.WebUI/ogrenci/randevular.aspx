<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="randevular.aspx.cs" Inherits="DRS.WebUI.ogrenci.randevular" %>
    ...
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary st fixed-top" style="background-color: darkslateblue !important;">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                ...
                <div class="p2">
                    <asp:LinkButton CssClass="profilAd" ID="lnkbtnProfil" runat="server">
                        <i class="fa fa-user"></i>
                        <asp:Label ID="lblKullaniciAdi" runat="server" Text=""></asp:Label>
                    </asp:LinkButton>
                    <asp:LinkButton CssClass="cikisbtn" ID="lnkBtnCikisYap" runat="server"> <i class="fa fa-sign-out"></i>  Çıkış Yap</asp:LinkButton>
        ...
        <asp:Button ID="btnIslem" runat="server" Text="" BorderWidth="0" Width="0" Height="0" OnClick="RandevuIslem" />
